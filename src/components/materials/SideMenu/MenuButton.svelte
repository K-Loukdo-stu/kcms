...
<div class="select-none">
	{#if !hasSubMenu}
		<a {href}>
			<div
				class={"transition duration-150 ease-in-out  text-gray-600 p-2 px-4 w-full rounded-md hover:bg-gray-600 hover:text-white text-lg mb-1 " +
					tailwindClass +
					" " +
					(active ? "bg-gray-600 text-white" : "bg-white")}
			>
	...
	{:else}
		<div>
			<button
				...
				class={"text-left  relative cursor-pointer transition duration-150 ease-in-out bg-white text-gray-600 p-2 px-4 w-full rounded-md hover:bg-gray-600 hover:text-white text-lg mb-1 " +
					tailwindClass +
					" " +
