<script>
	...
	import { createProductType } from '$providers/actions/kchannel/product-type';
	...
	let productTypeCatalogsSelected = productTypeCatalogsData?.length
		? productTypeCatalogsData[0]
		: null;
