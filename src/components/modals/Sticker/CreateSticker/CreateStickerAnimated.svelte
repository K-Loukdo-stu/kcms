							...
							{#if params.base64}
								<div class="absolute w-full">
									<div class=" overflow-auto w-full">
										<div
											style="width: {params.originalWidth / scale}px; 
								...
								<!-- <div class="absolute" style="width: {params.originalWidth / scale}px; height: {params.originalHeight / scale}px;">
									<img
										src={params.base64}
										class=" w-full h-full text-gray-600 p-1 rounded-md"
										alt=""
									/>
								</div> -->
							{:else}
					...
					<div class=" flex flex-col p-7 pt-0 space-y-4">
						...
						<div class="flex flex-row w-full space-x-5">
							<div class=" flex justify-center w-full">
								<button
									on:click|preventDefault={() => (onModal.shownModal = true)}
