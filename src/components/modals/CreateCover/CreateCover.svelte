<script>
	...
	import { createCover } from "$providers/actions/kart";
	...
	<div class="absolute bg-white rounded-lg">
		<div class="relative w-72 h-[500px]">
			<div class="relative py-6 px-6 lg:px-8">
				<h3 class="mb-4 text-base font-medium text-gray-700 text-center">
					New Cover
				</h3>
				<form
					class="space-y-6"
				...
				>
					<div
						class="relative flex justify-center items-center w-full flex-col"
					>
						<div class="mb-2">
							<input
								type="text"
						...
						<label
							for="dropzone-file"
							class="flex flex-col justify-center items-center w-48 h-72 bg-gray-50 rounded-lg border-2 shadow-md cursor-pointer hover:bg-bray-800 bg-gray-700 hover:bg-gray-100 border-gray-600 hover:border-gray-500 hover:bg-gray-600"
						>
