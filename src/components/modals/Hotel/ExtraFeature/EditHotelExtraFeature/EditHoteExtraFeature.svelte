<script>
	...
	import { updateHotelExtraFeature } from '$providers/actions/ktour/hotel/extra-feature';
	...
	export let hotel;
	let id = params.id;
	let additionalItem = params.additionalItem;
	let price = params.price;
	let mediaFile = params.mediaFile;
	...
	const onUpdate = async (evt) => {
		...
		if (base64) {
			...
			let res = await updateHotelExtraFeature.load({
				id,
				additionalItem,
				price,
				mediaFile,
