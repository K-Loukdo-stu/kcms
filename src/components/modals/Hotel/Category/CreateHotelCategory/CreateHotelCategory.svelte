<script>
	...
	import { createHotelCategory } from '$providers/actions/ktour/hotel';
	import { uploadHotelCategory } from '$providers/actions/storage/hotel-category';
	...
	const onCreatePlaceCategory = async (evt) => {
		evt.preventDefault();
		uploading = true;
		await uploadHotelCategory.load({
			base64,
			onComplete: (res) => {
				// to do
				createHotelCategory
	...
	<div class=" absolute bg-white">
		<div class="relative w-80 h-[400px]">
			...
			<form
				...
				on:submit|preventDefault={onCreatePlaceCategory}
				method="post"
			>
				<div class="flex-grow">
					<div>
