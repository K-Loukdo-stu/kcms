...
<table class="table-auto w-full mt-5">
	...
	<tbody class="text-sm divide-y divide-gray-300 text-[#585861]">
		{#each provicesData as province}
			<tr>
				<td class="p-2">
					<div class=" text-gray-600 text-center">{province.name}</div>
				</td>
