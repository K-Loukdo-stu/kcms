...
<table class="table-auto w-full mt-5">
	<thead class="text-sm  bg-[#787878] text-[#FFFFFF] ">
		<tr>
			<th>
				<div class="font-semibold text-center">In Date</div>
			</th>
			<th class="p-2">
				<div class="font-semibold text-center">Out Date</div>
			</th>
			<th class="p-2">
	...
	<tbody class="text-sm divide-y divide-gray-300 text-[#585861]">
		{#each Data as data}
			<tr>
				<td class="p-2">
					<div class=" text-gray-600 text-center">{data.checkInDate}</div>
				</td>

				<td class="p-2">
					<div class=" text-gray-600 text-center">{data.checkOutDate}</div>
				</td>
				<td class="p-2">
					<div class=" text-gray-600 text-center">{data.number}</div>
				</td>

				<td class="p-2">
					<div class=" text-gray-600 text-center">{data.price}</div>
				</td>
