	...
	<div class=" w-full h-full">
		<DashboardLayout>
			<div slot="menu">
				...
				/>
				<div class="pl-5">
					<MenuButton title="category" href="/dashboard/kloukdo/category" />
				</div>
				<div class="pl-5">
					<MenuButton title="sub-category" href="/dashboard/kloukdo/sub-category" />
				</div>
				<div class="pl-5">
					<MenuButton title="promotion" href="/dashboard/kloukdo/promotion" />
				</div>
			</div>
